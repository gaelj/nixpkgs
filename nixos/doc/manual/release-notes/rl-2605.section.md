...
- [crowdsec-blocklist-import](https://www.crowdsec.net/), aggregates threat intelligence from 28+ public blocklists and imports them directly into CrowdSec with automatic deduplication. Available as [services.crowdsec-blocklist-import](#opt-services.crowdsec-blocklist-import.enable).

- [airsonic-refix](https://github.com/tamland/airsonic-refix), a modern responsive web frontend for airsonic-advanced, navidrome, gonic and other subsonic compatible music servers. Available as [services.airsonic-refix](#opt-services.airsonic-refix.enable).
...
- []{#sec-release-26.05-incompatibilities-services-honk-removed} `services.honk` has been removed due to lack of maintenance upstream, and source repository is now no longer existing.
